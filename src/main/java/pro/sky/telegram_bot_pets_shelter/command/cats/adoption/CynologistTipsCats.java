 ...
 */
@Component
public class CynologistTipsCats implements Command {

    private final MessageUtils messageUtils;
    private final BuilderKeyboard keyboard;

    public CynologistTipsCats(MessageUtils messageUtils, BuilderKeyboard keyboard) {
    ...
    public SendMessage execute (Update update){
        ...
        return messageUtils.generationSendMessage(update,markup,"Tips from an experienced cynologist.");
    }
}