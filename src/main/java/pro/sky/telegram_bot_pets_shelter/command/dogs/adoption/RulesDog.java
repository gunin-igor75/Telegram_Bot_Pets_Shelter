...
/**
 * Данный класс формрует сообщения исходя из выбора rules for dating dog
 */
@Component
public class RulesDog implements Command {

    private final MessageUtils messageUtils;
    private final BuilderKeyboard keyboard;

    public RulesDog(MessageUtils messageUtils, BuilderKeyboard keyboard) {
    ...
    public SendMessage execute (Update update){
        ...
        return messageUtils.generationSendMessage(update,markup,"Мы только приветствуем, когда к нам приезжают в гости и помогают с уходом за животными." +
                ...
                "расспросите о прошлом собаки: как она попала в приют, какие у нее были хозяева;\n" +
                "как она себя обычно ведет;\n" +
